...
await driver.wait(until.titleIs('555 - Boekingsprogramma'), 10000);
console.log("Tabblad 2 boekingsprogramma geopend");
...
// await driver.findElement(By.xpath("(//div[contains(@onclick,'return false;')])[24]")).click();

await driver.switchTo().window(originalWindow);
console.log("factuur wordt nu in het originele tabblad gemaakt");
...
// await driver.findElement(By.name("ORDKOP_KENM")).sendKeys("Wing js script");
// await driver.findElement(By.name("OMSCHR")).sendKeys("Dit is een JS script");
...
console.log("alle checks worden nu in tweede tabblad uitgevoerd")
